<x-layout titulo="Letra E">    
  <nav class="navbar navbar-expand-lg sticky-top" style="background-color: #4782DA; padding-top: 20px; padding-bottom: 20px;">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
        <form method="post" action="{{ route('alunoaumentarprogressoletrae') }}">
        @csrf
        <div style="position: relative;">
            <img src="{{ URL::to('/assets/img/finalE.png') }}" class="d-block w-100" alt="...">
            <button @if(session('alunos')->botaoE) disabled @endif type="submit" style="
    ...
    <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleDark" data-bs-slide="next">
        ...
        <a href="examinarbotoesalfabeto"><button type="button" class="btn btn-danger"
