<x-layout titulo="Número 0">    
  <nav class="navbar navbar-expand-lg sticky-top" style="background-color: #34B764; padding-top: 20px; padding-bottom: 20px;">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <form method="post" action="{{ route('alunoaumentarprogressonumero0') }}">
          @csrf
            <div style="position: relative;">
              <img src="{{ URL::to('/assets/img/final0.png') }}" class="d-block w-100" alt="...">
              <button @if(session('alunos')->botao0) disabled @endif type="submit" style="background-color: #34B764; border: 2px solid black; border-radius: 30px; padding: 12px 24px; font-size: 18px; text-align: center; position: absolute; top: 85%;left: 50%; transform: translate(-50%, -50%);">
                Finalizar
              </button>
            </div>
          </form>
