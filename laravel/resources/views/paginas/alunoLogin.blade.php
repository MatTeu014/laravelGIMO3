  ...
  <nav class="navbar navbar-expand-lg" style="background-color: #f5e177; padding-top: 20px; padding-bottom: 20px;">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <form class="d-flex" role="search">
        <a href="alunosconsultarescola" class="btn ms-2"
      ...
      <form method="get" action="/alunoslogin">
        ...
        <div>
          <a href="/"><button type="button" class="btn btn-primary"
              style="background-color: white; color: #f5e177; border-color: #000000; border-radius: 30px; border-width: 2px; font-weight: bold; font-size: 18px; margin: auto; width: 15%; margin-right: 5%;">Voltar</button></a>
