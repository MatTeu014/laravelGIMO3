						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="nome" name="nome"
											placeholder="Digite seu nome" Disabled
								...
								<div class="col-md-6">
									...
									<div class="form-floating mb-3">
										<input type="email" class="form-control" id="email" name="email"
											placeholder="nome@exemplo.com" Disabled
											style="border-style: solid; border-color: #000000; border-width: 2px; border-radius: 26px;"
											value="{{ $alunos->email }}">
								...
								<div class="col-12 d-flex justify-content-center"
									...
									<a href="alunoHome"><button type="button" class="btn btn-danger"
											style="width: 100%; border-radius: 30px; font-size: 18px; padding: 12px 24px; background-color: #E5CD59; border-color: #E5CD59;">
											Voltar
										</button></a>
									<a href="{{ route('alunoseditar') }}"><button type="button" class="btn btn-danger"
