<x-layout titulo="Alterar Senha de Professor">
  ...
  <nav class="navbar navbar-expand-lg"
    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <form class="d-flex" role="search">
        <a class="btn"
          style="background-color: white; border: 0px solid black; border-radius: 30px; padding: 6px 17px; font-size: 19px; width: 130px; text-align: center; color:  rgb(245, 140, 109);">PROFESSOR</a>
      </form>
  ...
  <div class="card"
    style="width: 50%; border-color:rgb(245, 140, 109); border-width: 2px; margin: auto; border-radius: 30px; text-align: center;">
    <div class="card-body">
      ...
      <form action="" method="GET"> {{-- Ajuste a rota conforme necessário --}}
        ...
        <div>
          <button type="submit" class="btn btn-primary"
            style="background-color: white; color: rgb(245, 140, 109); border-color: #000000; border-radius: 30px; border-width: 2px; font-weight: bold; font-size: 17px; margin: auto; width: 20%;">Confirmar</button>
        </div>
        <br>
