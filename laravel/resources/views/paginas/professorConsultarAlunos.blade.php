<x-layout titulo="Professor Consultar Alunos para Alunos">
	...
	<h1 style="text-align: center; margin-top: 2%;">Escolha um Aluno</h1>
						...
						<div class="row align-items-center">
							...
							@foreach ($alunos as $aluno)
								<div class="card" style="width: 24rem; height: 35vh; border-color: white;">
									<div class="card-body">
										<button type="submit" name="nome" value="{{ $aluno->nome }}" style="font-size: 50px; border-radius: 30px; border-color: rgb(245, 101, 58); border-style: solid; background-color: white;">{{ $aluno->nome }}</button>
									</div>
								</div>
							@endforeach
