<x-layout titulo="Números Aluno">
  <nav class="navbar navbar-expand-lg sticky-top"
    style="background-color: #34B764; padding-top: 20px; padding-bottom: 20px;">
        ...
        <ul class="navbar-nav d-flex flex-row gap-3">
          <li class="nav-item">
            <a href="/alunoHome" class="btn btn-danger"
              style="background-color: #34B764; border: 2px solid black; border-radius: 30px; padding: 12px 24px; font-size: 18px; width: 120px; text-align: center;">Home</a>
          </li>
          <li class="nav-item">
            <a href="alunoSobrenos" class="btn btn-danger"
              style="background-color: #34B764; border: 2px solid black; border-radius: 30px; padding: 12px 24px; font-size: 18px; width: 120px; text-align: center;">Sobre</a>
          </li>
          <li class="nav-item">
            <a href="alunoAtividades" class="btn btn-danger"
              style="background-color: #34B764; border: 2px solid black; border-radius: 30px; padding: 12px 10px; font-size: 18px; width: 120px; text-align: center;">Atividades</a>
          </li>
          <li class="nav-item">
            <a href="{{ route('alunosrelatorio') }}" class="btn btn-danger"
              style="background-color: #34B764; border: 2px solid black; border-radius: 30px; padding: 12px 24px; font-size: 18px; width: 120px; text-align: center;">Relatório</a>
          </li>
        </ul>
      </div>
...
<div class="card-body" style="padding: 0; display: flex; align-items: center; justify-content: center;">
    <img src="{{URL::to('/assets/img/num0_4.png')}}" class="card-img-top" alt="..." style="width: 120px; height: 120px; object-fit: contain;">
        ...
        <div class="col">
          <div class="card">
            <a href="numero1">
              @if ($alunoss->botao1 == 0)
<div class="card-body" style="padding: 0; display: flex; align-items: center; justify-content: center;">
    <img src="{{URL::to('/assets/img/num1_4.png')}}" class="card-img-top" alt="..." style="width: 120px; height: 120px; object-fit: contain;">
        ...
        <div class="col">
          <div class="card">
            <a href="numero2">
              @if ($alunoss->botao2 == 0)
<div class="card-body" style="padding: 0; display: flex; align-items: center; justify-content: center;">
    <img src="{{URL::to('/assets/img/num2_4.png')}}" class="card-img-top" alt="..." style="width: 120px; height: 120px; object-fit: contain;">
        ...
        <div class="col">
          <div class="card">
            <a href="numero3">
              @if ($alunoss->botao3 == 0)
<div class="card-body" style="padding: 0; display: flex; align-items: center; justify-content: center;">
    <img src="{{URL::to('/assets/img/num3_4.png')}}" class="card-img-top" alt="..." style="width: 120px; height: 120px; object-fit: contain;">
        ...
        <div class="col">
          <div class="card">
            <a href="numero4">
              @if ($alunoss->botao4 == 0)
<div class="card-body" style="padding: 0; display: flex; align-items: center; justify-content: center;">
    <img src="{{URL::to('/assets/img/num4_5.png')}}" class="card-img-top" alt="..." style="width: 120px; height: 120px; object-fit: contain;">
        ...
        <div class="col">
          <div class="card">
            <a href="numero5">
              @if ($alunoss->botao5 == 0)
<div class="card-body" style="padding: 0; display: flex; align-items: center; justify-content: center;">
    <img src="{{URL::to('/assets/img/num5_5.png')}}" class="card-img-top" alt="..." style="width: 120px; height: 120px; object-fit: contain;">
        ...
        <div class="col">
          <div class="card">
            <a href="numero6">
              @if ($alunoss->botao6 == 0)
<div class="card-body" style="padding: 0; display: flex; align-items: center; justify-content: center;">
    <img src="{{URL::to('/assets/img/num6_4.png')}}" class="card-img-top" alt="..." style="width: 120px; height: 120px; object-fit: contain;">
        ...
        <div class="col">
          <div class="card">
            <a href="numero7">
              @if ($alunoss->botao7 == 0)
<div class="card-body" style="padding: 0; display: flex; align-items: center; justify-content: center;">
    <img src="{{URL::to('/assets/img/num7_4.png')}}" class="card-img-top" alt="..." style="width: 120px; height: 120px; object-fit: contain;">
        ...
        <div class="col">
          <div class="card">
            <a href="numero8">
              @if ($alunoss->botao8 == 0)
<div class="card-body" style="padding: 0; display: flex; align-items: center; justify-content: center;">
    <img src="{{URL::to('/assets/img/num8_4.png')}}" class="card-img-top" alt="..." style="width: 120px; height: 120px; object-fit: contain;">
        ...
        <div class="col">
          <div class="card">
            <a href="numero9">
              @if ($alunoss->botao9 == 0)
<div class="card-body" style="padding: 0; display: flex; align-items: center; justify-content: center;">
    <img src="{{URL::to('/assets/img/num9_4.png')}}" class="card-img-top" alt="..." style="width: 120px; height: 120px; object-fit: contain;">
...
@endif
        ...
        <div class="col">
          <div class="card">
            <a href="numero10">
              @if ($alunoss->botao10 == 0)
<div class="card-body" style="padding: 0; display: flex; align-items: center; justify-content: center;">
    <img src="{{URL::to('/assets/img/num10_6.png')}}" class="card-img-top" alt="..." style="width: 120px; height: 120px; object-fit: contain;">
    
</div>
@endif
              
              @if ($alunoss->botao10 == 1)
<div class="card-body" style="padding: 0; display: flex; align-items: center; justify-content: center;">
    <img src="{{URL::to('/assets/img/num10_6.png')}}" class="card-img-top" alt="..." style="width: 120px; height: 120px; object-fit: contain;">
    <div style="
        position: absolute;
