<x-layout titulo="Professor Consultar Séries para Alunos">
				...
				<ul class="navbar-nav d-flex flex-row gap-3">
					...
					<div class="dropdown ms-2">
						<button class="btn dropdown-toggle"
							style="background-color: rgb(245, 101, 58); border: 2px solid black; border-radius: 30px; padding: 6px 10px; font-size: 19px; width: 100%; text-align: center; color: white; height: 55px;"
	...
	<h1 style="text-align: center; margin-top: 2%;">Escolha uma Série para o Relatório do Aluno</h1>

	<section class="py-5" style="padding-top: 80px; text-align: center; height: 50vh;">
		<div class="container" style="margin: auto;">
			<div class="row align-items-center">

				<form action="professorconsultarturmasalunos" method="get">
