<x-layout titulo="Professor Consultar Turmas para Alunos">
	...
	<h1 style="text-align: center; margin-top: 2%;">Escolha uma Turma para o Relatório do Aluno</h1>

	<section class="py-5" style="padding-top: 80px; text-align: center; height:50vh">
		<div class="container" style="margin: auto;">
			<div class="row align-items-center">

				<form action="professorconsultaralunos" method="get">
