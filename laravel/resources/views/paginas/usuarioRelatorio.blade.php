    ...
    <div class="container" style="margin: auto;">
      <div class="row align-items-center">
        ...
        <div class="col-md-6">
          ...
          <p>• Bem-vindo a área dos relatórios. Aqui você poderá consultar seu desenvolvimento das atividades do site,
            aparecendo a sua porcentagem de progresso das atividades, tanto das letras do alfabeto e dos números.</p>
          <p>• Assim que acabar e completar os 100% em ambas as áreas, se quiser refazer seu progresso, só clicar em
            Resetar Progresso.</p>
        ...
        <div class="col-md-6 text-center">
          <img src="{{URL::to('/assets/img/img_relatorio.png')}}" alt="Imagem ilustrativa" class="img-fluid rounded"
            style="width: 400px;">
        </div>
        ...
        <div class="progress" role="progressbar" aria-label="Example with label" aria-valuenow="25" aria-valuemin="0"
          aria-valuemax="100">
          <div class="progress-bar" style="width: {{ $usuarios->progressoletras }}%">
            {{ $usuarios->progressoletras + 1.2 }}%</div>
        </div>
        ...
        <div class="progress" role="progressbar" aria-label="Success example" aria-valuenow="25" aria-valuemin="0"
          aria-valuemax="100">
          <div class="progress-bar text-bg-success" style="width:{{ $usuarios->progressonumeros }}%">
            {{ $usuarios->progressonumeros + 0.01 }}%</div>
        </div>
